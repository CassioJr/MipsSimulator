package processador.pipeline;

public class BlocoControle{

    //Sinais aluOp0, aluOp1 e lui v√£o para o ULA Control, para definir a opera√ß√£o a ser feita na ULA
    //Se lui = 1, ula instruction = sll
    //Sen√£o, aluOp0/1 01 = Type-R (define instruction pela funct), 00 = Lw/Sw/Addiu (intruction = Add)
    ...
    public void controlByOpCode (String opCode) {
        ...
        //Ori - Usa o aluOp0/1 com 11, vai ser usado para passar uma instruÁ„o or para a ULA
        ...
        //Lui - Sinal de controle lui criado para passar a instruÁ„o sll para a ULA.
    ...
    //FunÁıes diferentes para MUXs diferentes. Terceiro parametro ja indica o(s) sinal(is) de controle a ser(em) usado(s).
    public static int writeRegMux(int ent0, int ent1, int regDst){
        if(regDst == 0){return ent0;}
        if(regDst == 1){return ent1;}
        System.out.println("Erro na opera√ß√£o de controle do writeRegMux!!!");
        return -1;
    }
    ...
    public static int aluOp2Mux(int ent0, int ent1, int aluSrc){
        ...
        System.out.println("Erro na opera√ß√£o de controle do aluOP2Mux!!!");
        return -1;
    }
    ...
    public static int shiftControlMux(int ent0, int ent1, int shamt){
        ...
        System.out.println("Erro na opera√ß√£o de controle dos shift");
        return -1;
    }

    //Define a operaÁıes da ULA com base nos inputs de controle. Retorna operaÁ„o conforme codigos do switch do ULA.java
    // function
    public int ulaControl(int ulaOp0, int ulaOp1, int lui, String funct){
        ...
        System.out.println("Erro na escooa de opera√ß√£o da ulaControl!!!");
        return -1;
    }
